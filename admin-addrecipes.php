...
session_start();
include("db.php");
include("adminfdrecipes-add.php");
$query = mysqli_query($conn,"select * from add_recipes");
?>
<!DOCTYPE html>
<html>
<head>
  ...
  <script src="https://cdn.tiny.cloud/1/foh3axyvm3mn02es8orlgm4glbr9msylo7d8tj1npeh2tjya/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
 	...
 	<div class="main_container">
 		<div class="item">
 			 ...
 			 <form  method="post" action="adminfdrecipes-add.php" enctype="multipart/form-data">
			  	<label for="fname">Dish Title :</label>
			  	<input type="text" name="title" placeholder="Enter Name..." required><br>
			  	<label for="fname"> Food Cuisine name:</label>
			  	<input type="text"  name="cuisine" placeholder="Enter Cuisine..." required><br>
			  	 <label for="file">Image Path :</label>
			    <input type="file" class="form-control"  name="image" required><br>
			    <label for="fname">Description :</label><br>
			    <textarea  name="recipes" placeholder="Write Recipes....." class="form-control" style="height:150px" required></textarea><br>
			    <input type="submit"  name="submit" value="📌Add Recipes">
			</form>
							    ...
							    <table class="table table-striped table-dark table-hover table-bordered">
									  ...
									  <tbody>
									    ...
									    <tr>
									      ...
									      <TD>  
									      	<a href="adminfdrecipes-update.php?id=<?php echo $row['id'];?>" style="color: white">
									      	<button type="button" class="btn btn-info badge-pill"  id="slidebtn"  name="update" style="width: 80px;">EDIT</button></a>
									      </TD>


									      	<TD>
									      	<a href="adminfdrecipes-delete.php?id=<?php echo $row['id'];?>" style="color:white;">
