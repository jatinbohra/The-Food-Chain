 	...
 	<div class="sidebar">
 		<ul>
 			...
 			<li><a href="admin-profile.php">
 				...
 				<span class="title">New Profile</span>
 			</a></li>
									  ...
									  <tbody>
									    ...
									    <tr>
									      ...
									      <TD>  
									      	...
									      	<TD>
									      	<a href="adminstmenu-delete.php?id=<?php echo $r['id'];?>" style="color:white;">
