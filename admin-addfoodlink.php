 	...
 	<div class="main_container">
 		<div class="item">
		  ...
		  <form  method="post" action="adminfdlink-add.php" enctype="multipart/form-data">
		  	...
		  	<input type="text" name="linkname" placeholder="Enter Name..." required><br>
		    ...
		    <input type="file" class="form-control" id="name" placeholder="" name="img"><br>
		    <input type="submit"  name="submit" value="📌Add Recipes Link ">
		   </form>
							    ...
							    <table class="table table-striped table-dark table-hover table-bordered">
									...
									?>
									    ...
									    <tr>
										  ...
										  <td><?php echo $r['linkname']; ?></td>
										  <td><?php echo $r['Description']; ?></td>
										  <td><?php echo $r['cuisine']; ?></td>
									      <td><img src="<?php echo $r['img']; ?>" width="100" height="100"></td>
									      
									      
									    <TD>  
									      	<a href="adminfdlink-update.php?id=<?php echo $r['id'];?>" style="color: white">
