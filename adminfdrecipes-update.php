...
$id = $_REQUEST['id'];
  $data =mysqli_query($conn, "update add_recipes set image='$folder', title='$title', cuisine='$cuisine', recipes='$recipes' where id ='$id'");
 	if($data=true)
 	{
...
<!--Update form -->
	<div class="main_container">
 		<div class="item">
			...
			include("db.php"); 
				$id = $_REQUEST['id'];
				$data=mysqli_query($conn,"select * from add_recipes where id = '$id'");
			...
			<textarea  name="recipes" class="form-control form-control-lg" placeholder="Write Recipes....." style="height:150px" required></textarea><br>
		    <input type="submit"  name="update" value="📌update Recipes">
		   </form>
